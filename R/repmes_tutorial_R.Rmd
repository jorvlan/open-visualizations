...
if (save_image == TRUE) {
ggsave('../tutorial_R/figs_repmes/figure1.png', width = w, height = h, dpi = 150, units = 'in')
}
...
f6 <- ggplot(data = d, aes(y = y)) +
   ...
   geom_errorbar(data = d %>% filter(x=="2"), aes(x = x, y = score_mean[2], 
    ymin = score_ci_2[3], 
    ymax = score_ci_2[1]), position = position_nudge(.13), color = "darkorange", 
...
f8 <- ggplot(data = d, aes(y = y)) +
   ...
   geom_errorbar(data = d %>% filter(x=="2"), aes(x = x, y = score_mean[2], 
    ymin = score_ci_2[3],  
    ymax = score_ci_2[1]), position = position_nudge(x = -1.1), color = "darkorange", 
    width = 0.05, size = 0.4, alpha = .6) +
   ...
   geom_errorbar(data = d %>% filter(z=="3"), aes(x = z, y = score_mean[1], 
    ymin = score_ci_1[3], 
    ymax = score_ci_1[1]), position = position_nudge(1.15), 
    color = "dodgerblue", width = 0.05, size = 0.4, alpha = .5)+ 
   ...
   geom_errorbar(data = d %>% filter(z=="4"), aes(x = z, y = score_mean[2], 
    ymin = score_ci_2[3], ymax = score_ci_2[1]), position = position_nudge(.15), 
...
f9 <- ggplot(data = d, aes(y = y)) +
   ...
   geom_errorbar(data = d %>% filter(x=="2"), aes(x = x, y = score_mean[2], 
    ymin = score_ci_2[3],   
    ymax = score_ci_2[1]), position = position_nudge(x = .13), color = "darkorange", 
    width = 0.05, size = 0.4, alpha = .6) +
   geom_point(data = d %>% filter(z=="3"), aes(x = z, y = score_mean[1]), 
   ...
   geom_errorbar(data = d %>% filter(z=="3"), aes(x = z, y = score_mean[1], 
    ymin = score_ci_1[3], 
    ymax = score_ci_1[1]), position = position_nudge(-.13), 
    color = "dodgerblue", width = 0.05, size = 0.4, alpha = .5)+ 
   geom_point(data = d %>% filter(z=="4"), aes(x = z, y = score_mean[2]), 
