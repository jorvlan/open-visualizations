...
path1 <- 'C:\\Users\\jorvlan\\Documents\\tutorial_R\\figs_repmes'

path <- dir.create('..\\tutorial_R\\figs_repmes', showWarnings = T)
```
...
```{r figure 15, include = TRUE, eval = TRUE, echo = TRUE, message = FALSE}
before = iris$Sepal.Length[1:50] 
after = iris$Sepal.Length[51:100]
n <- length(before) 
d <- data.frame(y = c(before, after),
...
f15 <- ggplot(data=d, aes(y=y)) +

    #Add geom_() objects
    geom_point(data = d %>% dplyr::filter(x =="1"), aes(x = xj), color = 'dodgerblue', size = 1.5,
               alpha = .6) +
    geom_point(data = d %>% dplyr::filter(x =="2"), aes(x = xj), color = 'darkred', size = 1.5,
               alpha = .6) +
    geom_point(data = d %>% dplyr::filter(z =="3"), aes(x = xj_2), color = 'darkorange', size = 1.5,
               alpha = .6) +
    geom_point(data = d %>% dplyr::filter(z =="4"), aes(x = xj_2), color = 'darkgreen', size = 1.5,
               alpha = .6) +
    
    geom_point(data = d %>% dplyr::filter(x1 =="5"), aes(x = xj_3), color = 'dodgerblue', size = 1.5,
               alpha = .6) +
    geom_point(data = d %>% dplyr::filter(x1 =="6"), aes(x = xj_3), color = 'darkred', size = 1.5,
               alpha = .6) +
    geom_point(data = d %>% dplyr::filter(z1 =="7"), aes(x = xj_4), color = 'darkorange', size = 1.5,
               alpha = .6) +
    geom_point(data = d %>% dplyr::filter(z1 =="8"), aes(x = xj_4), color = 'darkgreen', size = 1.5,
               alpha = .6) +

    geom_point(data = d %>% dplyr::filter(x2 =="9"), aes(x = xj_5), color = 'darkorange', size = 1.5,
               alpha = .6) +
    geom_point(data = d %>% dplyr::filter(x2 =="10"), aes(x = xj_5), color = 'darkgreen', size = 1.5,
               alpha = .6) +
    ...
    # geom_half_boxplot(
    #   data = d %>% dplyr::filter(x=="1"), aes(x=x, y = y, color = 'blue', fill = 'blue'), position = position_nudge(x = -.37),
    #   side = "l",outlier.shape = NA, center = TRUE, errorbar.draw = FALSE, width = .2, alpha = .6) +
    # 
    # geom_half_boxplot(
    #   data = d %>% dplyr::filter(x=="2"), aes(x=x, y = y, color = 'blue', fill = 'blue'), position = position_nudge(x = -1.23),
    #   side = "l",outlier.shape = NA, center = TRUE, errorbar.draw = FALSE, width = .2, alpha = .6) +
    # 
    # geom_half_boxplot(
    #   data = d %>% dplyr::filter(z=="3"), aes(x=z, y = y, color = 'blue', fill = 'blue'), position = position_nudge(x = 1.23),
    #   side = "r",outlier.shape = NA, center = TRUE, errorbar.draw = FALSE, width = .2, alpha = .6) +
    # 
    # geom_half_boxplot(
    #   data = d %>% dplyr::filter(z=="4"), aes(x=z, y = y, color = 'blue', fill = 'blue'), position = position_nudge(x = .37),
    #   side = "r",outlier.shape = NA, center = TRUE, errorbar.draw = FALSE, width = .2, alpha = .6) +
    # 
    # geom_half_violin(
    #   data = d %>% dplyr::filter(x=="1"),aes(x = x, y = y, color = 'blue', fill = 'blue'), position = position_nudge(x = -.5),
    #   side = "l", alpha = .6) +
    # 
    # geom_half_violin(
    #   data = d %>% dplyr::filter(x=="2"),aes(x = x, y = y, color = 'blue', fill = 'blue'), position = position_nudge(x = -1.5),
    #   side = "l", alpha = .6) +
    # 
    # geom_half_violin(
    #   data = d %>% dplyr::filter(z=="3"),aes(x = z, y = y, color = 'blue', fill = 'blue'), position = position_nudge(x = 1.5),
    #   side = "r", alpha = .6) +
    # 
    # geom_half_violin(
    #   data = d %>% dplyr::filter(z=="4"),aes(x = z, y = y, color = 'blue', fill = 'blue'), position = position_nudge(x = .5),
    #   side = "r", alpha = .6) +
...
f16 <- ggplot(data=d, aes(y=y)) +
    ...
    geom_point(data = d %>% dplyr::filter(x2 =="9"), aes(x = xj_5), color = 'dodgerblue', size = 1.5,
               alpha = .6) +
    geom_point(data = d %>% dplyr::filter(x2 =="10"), aes(x = xj_5), color = 'darkred', size = 1.5,
               alpha = .6) +
    ...
    geom_boxplot(
      data = d %>% dplyr::filter(x=="1"), aes(x=x), fill = 'dodgerblue',
      outlier.shape = NA, width = .2, alpha = .1) +

    geom_boxplot(
      data = d %>% dplyr::filter(x=="2"), aes(x=x), fill = 'darkred',
     outlier.shape = NA, width = .2, alpha = .1) +

    geom_boxplot(
      data = d %>% dplyr::filter(z=="3"), aes(x=z), fill = 'darkorange',
      outlier.shape = NA, width = .2, alpha = .1) +

    geom_boxplot(
      data = d %>% dplyr::filter(z=="4"), aes(x=z), fill = 'darkgreen',
      outlier.shape = NA, width = .2, alpha = .1) +

      
  
  geom_boxplot(
      data = d %>% dplyr::filter(x1=="5"), aes(x=x1), fill = 'dodgerblue',
      outlier.shape = NA, width = .2, alpha = .1) +

    geom_boxplot(
      data = d %>% dplyr::filter(x1=="6"), aes(x=x1), fill = 'darkred',
     outlier.shape = NA, width = .2, alpha = .1) +

    geom_boxplot(
      data = d %>% dplyr::filter(z1=="7"), aes(x=z1), fill = 'darkorange',
      outlier.shape = NA, width = .2, alpha = .1) +

    geom_boxplot(
      data = d %>% dplyr::filter(z1=="8"), aes(x=z1), fill = 'darkgreen',
      outlier.shape = NA, width = .2, alpha = .1) +
  
    
    geom_boxplot(
      data = d %>% dplyr::filter(x2=="9"), aes(x=x2), fill = 'dodgerblue',
      outlier.shape = NA, width = .2, alpha = .1) +

    geom_boxplot(
      data = d %>% dplyr::filter(x2=="10"), aes(x=x2), fill = 'darkred',
      outlier.shape = NA, width = .2, alpha = .1) +
...
f16
ggsave('figure17.png', width = w, height = h, units='in', dpi=600)
ggsave("figure16.tiff", height=h, width=w, units='in', dpi=600)
```
```{r}
...
f17 <- ggplot(data=d, aes(y=y)) +
   ...
   geom_half_violin(
     data = d %>% filter(x=="1"),aes(x = x), position = position_nudge(x = 0), 
     side = "l", fill = 'dodgerblue', alpha = .15, color = "white", trim = TRUE) +
 
   geom_half_violin(
     data = d %>% filter(x=="2"),aes(x = x), position = position_nudge(x = 0), 
     side = "r", fill = "darkred", alpha = .15, color = "white", trim = TRUE) +
   
   geom_half_violin(
     data = d %>% filter(z=="3"),aes(x = z), position = position_nudge(x = 0), 
     side = "l", fill = "darkorange", alpha = .15, color = "white", trim = TRUE) +
   
   geom_half_violin(
     data = d %>% filter(z=="4"),aes(x = z), position = position_nudge(x = 0), 
     side = "r", fill = 'darkgreen', alpha = .15, color = "white", trim = TRUE) +
 
   geom_half_violin(
     data = d %>% filter(x1=="5"),aes(x = x1), position = position_nudge(x = 0), 
     side = "l", fill = "dodgerblue", alpha = .15, color = "white", trim = TRUE) +
   
   geom_half_violin(
     data = d %>% filter(x1=="6"),aes(x = x1), position = position_nudge(x = 0), 
     side = "r", fill = "darkred", alpha = .15, color = "white", trim = TRUE) +
  
   geom_half_violin(
     data = d %>% filter(z1=="7"),aes(x = z1), position = position_nudge(x = 0), 
     side = "l", fill = "darkorange", alpha = .15, color = "white", trim = TRUE) +
   
   geom_half_violin(
     data = d %>% filter(z1=="8"),aes(x = z1), position = position_nudge(x = 0), 
     side = "r", fill = 'darkgreen', alpha = .15, color = "white", trim = TRUE) +
 
   geom_half_violin(
     data = d %>% filter(x2=="9"),aes(x = x2), position = position_nudge(x = 0), 
     side = "l", fill = "dodgerblue", alpha = .15, color = "white", trim = TRUE) +
   
   geom_half_violin(
     data = d %>% filter(x2=="10"),aes(x = x2), position = position_nudge(x = 0), 
     side = "r", fill = "darkred", alpha = .15, color = 'white', trim = TRUE) +
...
ggsave('figure19.png', width = w, height = h, units='in', dpi=600)
```


```{r}

f20 <- ggplot(data=d, aes(y=y)) +
   ...
   geom_half_violin(
     data = d %>% filter(x=="1"),aes(x = x), position = position_nudge(x = 0), 
     side = "l", fill = 'dodgerblue', alpha = .15, color = "lightgray", trim = TRUE) +
 
   geom_half_violin(
     data = d %>% filter(x=="2"),aes(x = x), position = position_nudge(x = 0), 
     side = "r", fill = "darkred", alpha = .15, color = "lightgray", trim = TRUE) +
   
   geom_half_violin(
     data = d %>% filter(z=="3"),aes(x = z), position = position_nudge(x = 0), 
     side = "l", fill = "darkorange", alpha = .15, color = "lightgray", trim = TRUE) +
...
ggsave('figure20.png', width = w, height = h, units='in', dpi=600)
